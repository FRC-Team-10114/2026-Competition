...
public class IntakeConstants {
    ...
    public static final class ArmConstants {
        ...
        public static final Angle FORWARD_LIMIT = Radians.of(0.0);
        public static final Angle REVERSE_LIMIT = Radians.of(0.0);
    ...
    public static final class RollerConstants {
        ...
        public static final Current STATOR_CURRENT_LIMIT = Amp.of(70);
