...
public class TurretIOSpark extends TurretIO {
        ...
        public void configureMotors() {
                ...
                turretConfig.softLimit
                                ...
                                .reverseSoftLimit(ShooterConstants.HARD_MIN_LIMIT) // 硬體保護
                                .forwardSoftLimitEnabled(true)
                                .forwardSoftLimit(ShooterConstants.HARD_MAX_LIMIT);

                turretConfig.closedLoop
                                .pid(0.6, 0, 0);
                                 // P 值可能需要調大一點，因為單位是 Radians
        ...
        public Command sysid() {
                ...
                throw new UnsupportedOperationException("Unimplemented method 'sysid'");
        }
}
